...
otu_table_controls_top20$Control_Type <- ifelse(grepl("BS.", rownames(otu_table_controls_top20)), "Boostershot Positive",
                                                    ...
                                                    ifelse(grepl("EXT.POS", rownames(otu_table_controls_top20)), "Extraction Positive"))

otu_table_controls_top20$Control_Type <- factor(otu_table_controls_top20$Control_Type,
                                                levels = c("BoosterShot Positive",
                                                           "Extraction Positive"))
...
pdf("Outputs/Taxa_Stacked_Bar_Plots_for_Controls_Evvy_83_neg.pdf", height = 9, width = 15)
